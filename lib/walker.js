...
walker.walk = function(start, end, dostuff, done, waypoints) {
	...
	var directionsApiUrl = util.format('http://maps.googleapis.com/maps/api/directions/json?origin=%s&destination=%s&waypoints=optimize:true|%s', start, end, waypointsString);
